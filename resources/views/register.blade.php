                    ...
                    <div class=my-12>
                        ...
                        <div class="flex gap-2 mt-5">
                            <div class="w-172 h-12">
                                <input type="text" name="title" id="title" placeholder="INSERT TITLE" autofocus required 
                            ...
                            <x-categories_options :options="$categories" placeholder="SELECT CATEGORY"/>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 mt-5">
                            <div class="grow-1 w-172 h-12">
                                <input type="text" name="author" id="author" placeholder="NAME" autofocus required
                                    class="bg-stone-200 rounded-sm px-1 shadow-black inset-shadow-2xs text-xl font-semibold 
                                    py-2 outline-0 px-2 border-stone-300 focus:border-1 focus:px-3.5 transition-all duration-150 w-full">
                            </div>

                            <div class="h-12 w-32">
                                <input type="text" name="year" id="year" placeholder="INSERT YEAR" autofocus required value="{{ date('Y') }}"
                                    class="bg-stone-200 rounded-sm px-1 shadow-black inset-shadow-2xs text-xl font-semibold 
